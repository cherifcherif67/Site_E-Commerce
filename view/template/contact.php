    ...
    <div class="container" >
      <div class="row">
        <div class="col-md-4 p-b-30">
          <div class="hov-img-zoom" style="margin-top: 150px;">
            <img src="./img/image.jpg" alt="IMG-ABOUT">
          </div>
        </div>

        <div class="col-md-8 p-b-30" style="margin-top: 100px; margin-bottom: 150px;">
          <h3 class="m-text26 p-t-15 p-b-16">
            Our story
          </h3>

          <p class="p-b-28" style="width: 500px ;">
